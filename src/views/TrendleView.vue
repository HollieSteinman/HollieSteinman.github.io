      ...
      <n-layout-content>
        <main>
          <router-view v-slot="{ Component, route }">
            <transition
              :enter-active-class="
                route.meta.enterClass || 'animate__animated animate__fadeIn'
              "
              :leave-active-class="
                route.meta.leaveClass || 'animate__animated animate__fadeOut'
              "
            >
...
import MainHeader from "../components/trendle/header/MainHeader.vue";
